...
const MAGELLAN_STAGING_TARGET_VERSION = '2.5.0';
const MAGELLAN_STAGING_TARGET_ZIP     = 'https://github.com/urbanflowers-tech/MagellanOS-plugins/releases/download/v2.5.0/magellan-for-woocommerce-2.5.0.zip';
