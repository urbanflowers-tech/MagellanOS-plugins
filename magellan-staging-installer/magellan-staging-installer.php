...
const MAGELLAN_STAGING_TARGET_VERSION = '2.3.1';
const MAGELLAN_STAGING_TARGET_ZIP     = 'https://github.com/urbanflowers-tech/MagellanOS-plugins/releases/download/v2.3.1/magellan-for-woocommerce-2.3.1.zip';
