...
const MAGELLAN_STAGING_TARGET_VERSION = '2.4.2';
const MAGELLAN_STAGING_TARGET_ZIP     = 'https://github.com/urbanflowers-tech/MagellanOS-plugins/releases/download/v2.4.2/magellan-for-woocommerce-2.4.2.zip';
